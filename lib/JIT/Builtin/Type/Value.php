...
// Change /Users/ged15/Projects/php-compiler/lib/JIT/Builtin/Type/Value.pre instead.
...
class Value extends Type
{
    public function register(): void
    {
        ...
        $this->context->registerType(
            '__value__' . '**',
            $struct___cfcd208495d565ef66e7dff9f98764da->pointerType(0)->pointerType(0)
        );
    ...
    protected function implementValueDelref(): void
    {
        ...
        $oldType = $this->context->builder->load($this->context->builder->structGep($value, $offset));
        ...
        $this->context->builder->call($this->context->lookupFunction('__ref__delref'), $virtual);
    ...
    protected function implementValueToNumeric(): void
    {
        ...
        $type = $this->context->builder->load($this->context->builder->structGep($value, $offset));
        ...
        if (is_int(Variable::TYPE_NATIVE_LONG)) {
                ...
                end($__switches)->type->constInt(Variable::TYPE_NATIVE_LONG, false),
                $__case
            );
        ...
        $this->context->builder->call($this->context->lookupFunction('__ref__addref'), $var);
        ...
        if (is_int(Variable::TYPE_NATIVE_DOUBLE)) {
                ...
                end($__switches)->type->constInt(Variable::TYPE_NATIVE_DOUBLE, false),
                $__case
            );
        ...
        $result = $this->context->builder->call($this->context->lookupFunction('__value__toNumeric'), $num);
        ...
        $this->context->builder->call($this->context->lookupFunction('__ref__addref'), $virtual);
        if ($this->context->builder->getInsertBlock()->getTerminator() === null) {
            $this->context->builder->branch(end($endBlock));
        }
        ...
        $this->context->builder->call($this->context->lookupFunction('__value__writeLong'), $var, $tmp);
    ...
    protected function implementValueReadLong(): void
    {
        ...
        $result = $this->context->builder->call($this->context->lookupFunction('__value__readLong'), $varPtr);
        $this->context->builder->returnValue($result);
        if ($this->context->builder->getInsertBlock()->getTerminator() === null) {
            $this->context->builder->branch(end($__switches)->end);
            end($__switches)->endIsUsed = true;
    ...
    public function implementValueWriteLong(): void
    {
        ...
        $this->context->builder->store($type, $this->context->builder->structGep($value, $offset));
        $offset =
            $this->context->structFieldMap[
                $value
                    ->typeOf()
    ...
    protected function implementValueReadDouble(): void
    {
        ...
        $varPtr = $this->context->builder->structGep($ptr, $offset);
        $result = $this->context->builder->call($this->context->lookupFunction('__value__readDouble'), $varPtr);
        $this->context->builder->returnValue($result);
        if ($this->context->builder->getInsertBlock()->getTerminator() === null) {
            $this->context->builder->branch(end($__switches)->end);
            end($__switches)->endIsUsed = true;
    ...
    protected function implementValueReadString(): void
    {
        ...
        $varPtr = $this->context->builder->load($this->context->builder->structGep($var, $offset));
        $result = $this->context->builder->call($this->context->lookupFunction('__value__readString'), $varPtr);
        $this->context->builder->returnValue($result);
        if ($this->context->builder->getInsertBlock()->getTerminator() === null) {
            $this->context->builder->branch(end($__switches)->end);
            end($__switches)->endIsUsed = true;
    ...
    public function implementValueWriteString(): void
    {
        ...
        $this->context->builder->store($string, $this->context->builder->structGep($value, $offset));
        $this->context->builder->returnVoid();
